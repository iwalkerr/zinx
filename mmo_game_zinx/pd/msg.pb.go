...
type BroadCast struct {
	...
	Pid int32 `protobuf:"varint,1,opt,name=Pid,proto3" json:"Pid,omitempty"`
	Tp  int32 `protobuf:"varint,2,opt,name=Tp,proto3" json:"Tp,omitempty"` // 1世界聊天 2玩家位置 3动作 4移动之后的坐标
...
var file_msg_proto_rawDesc = []byte{
	0x0a, 0x09, 0x6d, 0x73, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x70, 0x64, 0x22,
	...
	0x0a, 0x01, 0x50, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x70, 0x64, 0x2e, 0x50,
	...
	0x0b, 0x32, 0x0a, 0x2e, 0x70, 0x64, 0x2e, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x52, 0x02, 0x70,
	...
	0x01, 0x50, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x70, 0x64, 0x2e, 0x50, 0x6f,
	0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x01, 0x50, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x3b, 0x70,
...
var file_msg_proto_goTypes = []interface{}{
	(*SyncPid)(nil),     // 0: pd.SyncPid
	(*Talk)(nil),        // 1: pd.Talk
	(*Position)(nil),    // 2: pd.Position
	(*BroadCast)(nil),   // 3: pd.BroadCast
	(*SyncPlayers)(nil), // 4: pd.SyncPlayers
	(*Player)(nil),      // 5: pd.Player
}
var file_msg_proto_depIdxs = []int32{
	2, // 0: pd.BroadCast.P:type_name -> pd.Position
	5, // 1: pd.SyncPlayers.ps:type_name -> pd.Player
	2, // 2: pd.Player.P:type_name -> pd.Position
